...
module ascii_sender (
    ...
    input             rst,
    input             start,
    input      [ 1:0] select,     //00: watch 01:stopwatch 10:sr04 11:dht11
    input      [31:0] data,
        ...
        case (c_state)
                ...
                if (bit_cnt_reg == 21) begin
                    ...
                    case (bit_cnt_reg)
                        ...
                        case (data[3:0])  //digit_10 msec
                            ...
                            4'b1001: data_reg[bit_cnt_reg] = 8'h39;  // 9
                        endcase
                        17: data_reg[bit_cnt_reg] = 8'h20;
                        18: data_reg[bit_cnt_reg] = 8'h20;
                        19: data_reg[bit_cnt_reg] = 8'h20;
                        20: data_reg[bit_cnt_reg] = 8'h20;
                    endcase
            ...
            SR04: begin
                ...
                if (bit_cnt_reg == 21) begin
                    ...
                    case (bit_cnt_reg)
                        0: data_reg[bit_cnt_reg] = 8'h74;  // t
                        1: data_reg[bit_cnt_reg] = 8'h65;  // e
                        2: data_reg[bit_cnt_reg] = 8'h6d;  // m
                        3: data_reg[bit_cnt_reg] = 8'h70;  // p
                        4: data_reg[bit_cnt_reg] = 8'h2f;  // /
                        5: data_reg[bit_cnt_reg] = 8'h68;  // h
                        6: data_reg[bit_cnt_reg] = 8'h75;  // u
                        7: data_reg[bit_cnt_reg] = 8'h6d;  // m
                        8: data_reg[bit_cnt_reg] = 8'h69;  // i
                        9: data_reg[bit_cnt_reg] = 8'h64;  // d
                        10: data_reg[bit_cnt_reg] = 8'h69;  // i
                        11: data_reg[bit_cnt_reg] = 8'h74;  // t
                        12: data_reg[bit_cnt_reg] = 8'h79;  // y
                        13: data_reg[bit_cnt_reg] = 8'h3a;  // :
                        14:
            ...
            DHT11: begin
                ...
                if (bit_cnt_reg == 21) begin
                    ...
                    case (bit_cnt_reg)
                        0: data_reg[bit_cnt_reg] = 8'h64;  // d
                        1: data_reg[bit_cnt_reg] = 8'h69;  // i
                        2: data_reg[bit_cnt_reg] = 8'h73;  // s
                        3: data_reg[bit_cnt_reg] = 8'h74;  // t
                        4: data_reg[bit_cnt_reg] = 8'h61;  // a
                        5: data_reg[bit_cnt_reg] = 8'h6e;  // n
                        6: data_reg[bit_cnt_reg] = 8'h63;  // c
                        7: data_reg[bit_cnt_reg] = 8'h65;  // e
                        8: data_reg[bit_cnt_reg] = 8'h3a;  // :
                        9:
                        case (data[11:8])  //digit_100 distance
                            4'b0000: data_reg[bit_cnt_reg] = 8'h30;  // 0
                            4'b0001: data_reg[bit_cnt_reg] = 8'h31;  // 1
                            4'b0010: data_reg[bit_cnt_reg] = 8'h32;  // 2
                            4'b0011: data_reg[bit_cnt_reg] = 8'h33;  // 3
                        ...
                        endcase
                        10:
                        case (data[7:4])  //digit_10 distance
                            4'b0000: data_reg[bit_cnt_reg] = 8'h30;  // 0
                            4'b0001: data_reg[bit_cnt_reg] = 8'h31;  // 1
                            4'b0010: data_reg[bit_cnt_reg] = 8'h32;  // 2
                            4'b0011: data_reg[bit_cnt_reg] = 8'h33;  // 3
                        ...
                        endcase
                        11:
                        case (data[3:0])  //digit_1 distance
                            4'b0000: data_reg[bit_cnt_reg] = 8'h30;  // 0
                            4'b0001: data_reg[bit_cnt_reg] = 8'h31;  // 1
                            4'b0010: data_reg[bit_cnt_reg] = 8'h32;  // 2
                            4'b0011: data_reg[bit_cnt_reg] = 8'h33;  // 3
                            ...
                            4'b1001: data_reg[bit_cnt_reg] = 8'h39;  // 9
                        endcase
                        12: data_reg[bit_cnt_reg] = 8'h20;
                        13: data_reg[bit_cnt_reg] = 8'h20;
                        14: data_reg[bit_cnt_reg] = 8'h20;
                        15: data_reg[bit_cnt_reg] = 8'h20;
                        16: data_reg[bit_cnt_reg] = 8'h20;
                        17: data_reg[bit_cnt_reg] = 8'h20;
                        18: data_reg[bit_cnt_reg] = 8'h20;
                        19: data_reg[bit_cnt_reg] = 8'h20;
                        20: data_reg[bit_cnt_reg] = 8'h20;
