...
module tb_top_uart ();
    ...
    initial begin
        ...
        rst = 1'b1;
        rx = 1'b1;  // idle
        select = 2'b00;  // default stopwatch
        data = {
            4'd1, 4'd3, 4'd5, 4'd7, 4'd3, 4'd7, 4'd9, 4'd8
        };  // 32'h17293879
        ...
        select = 2'b01;
        data = {4'd2, 4'd3, 4'd5, 4'd9, 4'd4, 4'd1, 4'd3, 4'd6};
        ...
        repeat (4000000) @(posedge clk);
        select = 2'b10;
        data = {4'd0, 4'd0, 4'd0, 4'd0, 4'd0, 4'd1, 4'd6, 4'd7};
        ...
        select = 2'b11;
        data = {4'd0, 4'd0, 4'd0, 4'd0, 4'd2, 4'd6, 4'd2, 4'd4};
        // --- S (0x53 = 0101_0011) ---
        rx = 1'b0;
        repeat (10416) @(posedge clk);  // start
        rx = 1'b1;
