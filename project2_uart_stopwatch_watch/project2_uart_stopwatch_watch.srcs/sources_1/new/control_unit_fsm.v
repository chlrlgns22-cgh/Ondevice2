...
module control_unit_fsm (
    ...
    // watch ctrl sig
    assign o_hour_up   = (o_hour & (btnU||uart_U));
    assign o_hour_down = (o_hour & (btnD||uart_D));
    assign o_min_up    = (o_min  & (btnU||uart_U));
    assign o_min_down  = (o_min  & (btnD||uart_D));
    assign o_sec_up    = (o_sec  & (btnU||uart_U));
    assign o_sec_down  = (o_sec  & (btnD||uart_D));
